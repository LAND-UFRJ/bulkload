...
Geolocation.init(
  {
    ...
    location:  { type: DataTypes.TEXT, allowNull: true, defaultValue: null },
    city:      { type: DataTypes.TEXT, allowNull: true, defaultValue: null },
    state:     { type: DataTypes.TEXT, allowNull: true, defaultValue: null },
    ...
    user_ppp:  { type: DataTypes.TEXT, allowNull: true, defaultValue: null },
  },
  {
    sequelize,
